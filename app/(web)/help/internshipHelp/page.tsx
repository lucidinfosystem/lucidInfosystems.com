...
export default function InternshipHelpPage() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-blue-500 mb-4 text-balance">
              You can make the most of your internship experience
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <Select value={formData.about} onValueChange={handleSelectChange}>
                ...
                <SelectContent>
                  <SelectItem value="internship-question">
                    Internship Question
                  </SelectItem>
                  <SelectItem value="program-info">
                    Program Information
                  </SelectItem>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-brand-secondary/10 file:text-brand-primary hover:file:bg-brand-primary/10"
                />
              </div>
              {formData.attachment && (
